...
(function (e) {
    ...
    (function (g) {
        var e = g.seriesType, C = g.seriesTypes, H = g.noop, D = g.pick, I = g.each;
        e("funnel", "pie", {
            animation: !1,
            center: ["50%", "50%"],
            width: "90%",
            ...
            animate: H, translate: function () {
                var b = function (a, b) {
                        ...
                        0, c = this.chart, f = this.options, d = f.reversed, e = f.ignoreHiddenPoint, t = c.plotWidth,
                    c = c.plotHeight, q = 0, g = f.center, h = b(g[0], t), r = b(g[1], c), C = b(f.width, t), l, v,
                    m = b(f.height, c), w = b(f.neckWidth, t), F = b(f.neckHeight, c), x = r - m / 2 + m - F,
                    b = this.data, z, A, D = "left" === f.dataLabels.position ? 1 : 0, B, n, G, u, k, y, p;
                ...
                var b = this.data, e = this.options.dataLabels.distance, c, f, d, g = b.length, t, q;
